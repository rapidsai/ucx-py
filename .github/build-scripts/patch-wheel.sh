...
mkdir -p ucx_py_${suffix}.libs/ucx
cd ucx_py_${suffix}.libs/ucx
cp -P /usr/lib/ucx/* .

# we link against <python>/lib/site-packages/ucx_py_${suffix}.lib/libuc{ptsm}
